...
// usage: logs('inside coolFunc',this,arguments);
...
//   vjs.logs('unloadingTech')
//   this.unloadTech();
//   vjs.logs('unloadedTech')
//   if (betweenFn) { betweenFn.call(); }
//   vjs.logs('LoadingTech')
...
vjs.Player.prototype.trackProgress = function(){
  ...
  this.progressInterval = setInterval(vjs.bind(this, function(){
    ...
    // logs(this.cache_.bufferEnd, this.buffered().end(0), this.duration())
...
vjs.ChaptersTrackMenuItem.prototype.update = function(){
  ...
  // vjs.logs(currentTime, cue.startTime);
