...
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'pearbook.settings') # 设置django环境
...
BROKER_URL = 'redis://localhost:6379/4' # Broker配置，使用Redis作为消息中间件

CELERY_RESULT_BACKEND = 'redis://localhost:6379/5' # Backend设置，使用redis作为后端结果存储
