...
from pearbook.rbac.views import user,organization,menu,role,permission
...
urlpatterns = [
    ...
    path(r'auth/login/', user.UserAuthView.as_view(), name='user_login'),
    ...
    path(r'organization/user/tree/', organization.OrganizationUserTreeView.as_view(), name='organization_user_tree'),
